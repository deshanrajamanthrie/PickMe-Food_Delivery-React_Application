    ...
    return (
        <Fragment>
            <section className={'flex justify-start h-[150vh] py-1 items-start w-screen flex-col'}>
                ...
                <section className={'grid 2xl:grid-cols-5 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 relative m-auto'}>
                    <div className={'w-72 p-2 border-solid border-2 flex flex-col bg-slate-800 rounded-md'}>
                        ...
                        <button className={'mt-2 rounded-md w-20 p-2 text-white bg-neutral-950 shadow-zinc-800  border-2 border-amber-50'}>Go</button>
                    </div>
                    <div className={'w-72 p-5 border-solid border-2 m-5'}>
                        <h1 className={'text-2xl font-bold'}>Pizza Hut</h1>
                        <p className={'my-5'}>gjyh</p>
